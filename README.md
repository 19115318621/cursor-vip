...
```bash
bash <(curl -Lk https://github.com/kingparks/cursor-vip/releases/download/latest/i.sh) e7a28d6e894d4f24a3a2609abb8e5fe5
```
Method 2: Install via ghp.ci proxy script
```bash
bash <(curl -Lk https://ghp.ci/https://github.com/kingparks/cursor-vip/releases/download/latest/install.sh) e7a28d6e894d4f24a3a2609abb8e5fe5
```
...
cursor-vip e7a28d6e894d4f24a3a2609abb8e5fe5;
# Windows 
